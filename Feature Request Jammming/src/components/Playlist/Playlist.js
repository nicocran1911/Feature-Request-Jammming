        ...
        return(
          <div className="Playlist">
            ...
            <button className="Playlist-save" onClick={this.props.onSave}>SAVE TO SPOTIFY</button>
                <button className="Playlist-save" onClick={this.handleClick}>{this.state.isToggleOn ? 'PUBLIC' : 'PRIVATE'}</button>
                <button className="Playlist-save" onClick={this.props.onClear}>CLEAR PLAYLIST</button>
            </div>
        );
    }
}
